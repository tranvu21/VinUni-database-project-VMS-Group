...
| **Milestone 3: Backend Development (API & Authentication)** | May 18       | Develop the backend with NextJS, including user authentication and basic CRUD functionality for managing students, professors, and staff. |
